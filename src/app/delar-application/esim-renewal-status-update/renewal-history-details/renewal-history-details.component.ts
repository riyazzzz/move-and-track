...
@Component({
  ...
  templateUrl: "./renewal-history-details.component.html",
  styleUrls: ["./renewal-history-details.component.scss"],
})
export class RenewalHistoryDetailsComponent implements OnInit {
