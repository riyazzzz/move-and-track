...
@Component({
  ...
  templateUrl: "./view-topup-details.component.html",
  styleUrls: ["./view-topup-details.component.scss"],
})
export class ViewTopupDetailsComponent implements OnInit {
  @Input() value;
  ...
  getdatas() {
    var url =
      serverUrl.web + "/esim/getTopupInvoiceDetails?invoiceno=" + this.value;
